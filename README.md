...
The Preview Feature in find duplicates. You can use find duplicates to find manga scanlation advertisements or webcomic title pages and exclude them from the image set, as shown here. 
<br>
<br>
